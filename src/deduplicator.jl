...
# deduplicator_copy(dedup::Deduplicator, x::ReadOnly) = x
# deduplicator_copy(dedup::Deduplicator, x::Array) = ReadOnly(x)


# deduplicate!(dedup::Deduplicator, x) = copy_nested(Base.Fix1(duplicator_copy, dedup), x)
